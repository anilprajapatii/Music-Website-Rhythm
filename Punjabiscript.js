...
var songarr = [
    { id: "1", songname: `Da Da dasse <br><div class = "subtitle" >Amit Triv</div>`, postert: "PunjabiPosters/1.jpg" },
    { id: "2", songname: `Laung Laachi<br><div class = "subtitle" >Ammy Virk</div>`, postert: "PunjabiPosters/2.jpg" },
    { id: "3", songname: `Khaab<br><div class = "subtitle" >Akhil</div>`, postert: "PunjabiPosters/3.jpg" },
    { id: "4", songname: `Viah<br><div class = "subtitle" >Jass Manak</div>`, postert: "PunjabiPosters/4.jpg" },
    { id: "5",songname: `Prada<br><div class = "subtitle" >Jass Manak</div>`, postert: "PunjabiPosters/5.jpg" },
    { id: "6", songname: `Pyaar<br><div class = "subtitle" >Mani</div>`, postert: "PunjabiPosters/6.jpg" },
    { id: "7", songname: `Rooh<br><div class = "subtitle" >Tej Gill</div>`, postert: "PunjabiPosters/7.jpg" },
    { id: "8", songname: `Raat Jashn di<br><div class = "subtitle" >Honey Singh</div>`, postert: "PunjabiPosters/8.jpg" },
    { id: "9", songname: `House Party<br><div class = "subtitle" >A KING</div>`, postert: "PunjabiPosters/9.jpg" },
    { id: "10", songname: `Backbone<br><div class = "subtitle" >Hardy Sandhu</div>`, postert: "PunjabiPosters/10.jpg" },
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index=el.target.id;
        poster.src=`PunjabiPosters/${index}.jpg`;
        DownloadMusic.href=`PunjabiSongs/${index}.mp3`;
        music.src=`PunjabiSongs/${index}.mp3`;
