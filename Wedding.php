    ...
    <header>
        ...
        <div class="user">
            ...
            <div class="menu-song">
                <li class="songItem">
                    <span>01</span>
                    <img src="WeddingPosters/1.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>02</span>
                    <img src="WeddingPosters/2.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>03</span>
                    <img src="WeddingPosters/3.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>04</span>
                    <img src="WeddingPosters/4.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>05</span>
                    <img src="WeddingPosters/5.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                    <h5>
                    Dostana 
                        <div class="subtitle">KK & Tulsi Kumar</div>
                ...
                <li class="songItem">
                    <span>06</span>
                    <img src="WeddingPosters/6.jpg" alt="Piya aaye na">
        ...
        <div class="icon">
            <i class="bi bi-music-note-beamed" id="CurrentSlogo"></i>
        </div>
         <img src="WeddingPosters/1.jpg" alt="KK & Tulsi kumar" id="small_poster">
         <h5 class="sname">Playing<br>
            ...
            <a href="/Songs/1.mp3" id="DownloadBtn" download><i class="bi bi-cloud-arrow-down-fill" id="DownloadBtnn"></i></a>
