    ...
    <header>
        ...
        <div class="user">
            ...
            <div class="menu-song">
                <li class="songItem">
                    <span>01</span>
                    <img src="PodcastPosters/1.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>02</span>
                    <img src="PodcastPosters/2.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>03</span>
                    <img src="PodcastPosters/3.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>04</span>
                    <img src="PodcastPosters/4.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>05</span>
                    <img src="PodcastPosters/5.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                    <h5>
                    Mysteries
                        <div class="subtitle">Podcast</div>
                ...
                <li class="songItem">
                    <span>06</span>
                    <img src="PodcastPosters/6.jpg" alt="Piya aaye na">
        ...
        <div class="icon">
         ...
         <img src="PodcastPosters/1.jpg" alt="KK & Tulsi kumar" id="small_poster">
         <h5 class="sname">Playing<br>
            ...
            <a href="PodcastSongs/1.mp3" id="DownloadMusic" download><i class="bi bi-cloud-arrow-down-fill" id="DownloadBtnn"></i></a>
