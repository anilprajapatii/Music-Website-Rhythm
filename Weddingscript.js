...
var songarr = [
    { id: "1", songname: `Chunnari Chunnari<br><div class = "subtitle" >Dhanush</div>`, postert: "WeddingPosters/1.jpg" },
    { id: "2", songname: `Masti movie song<br><div class = "subtitle" >Shreya Ghosal</div>`, postert: "WeddingPosters/2.jpg" },
    { id: "3", songname: `Awayie Awayie<br><div class = "subtitle" >Divine</div>`, postert: "WeddingPosters/3.jpg" },
    { id: "4", songname: `Dostana<br><div class = "subtitle" >Ash King</div>`, postert: "WeddingPosters/4.jpg" },
    { id: "5",songname: `Ye jawani hai diwani <br><div class = "subtitle" >Bazzi</div>`, postert: "WeddingPosters/5.jpg" },
    { id: "6", songname: `action replay<br><div class = "subtitle" >Armaan Malik</div>`, postert: "WeddingPosters/6.jpg" },
    { id: "7", songname: `Jhooth bole kaua <br><div class = "subtitle" >Honey Singh</div>`, postert: "WeddingPosters/7.jpg" },
    { id: "8", songname: `Shgna <br><div class = "subtitle" >Camila cabello</div>`, postert: "WeddingPosters/8.jpg" },
    { id: "9", songname: `Aaj sajyea<br><div class = "subtitle" >Anuradha</div>`, postert: "WeddingPosters/9.jpg" },
    { id: "10", songname: `Kuch to kaho<br><div class = "subtitle" >Charlie puth</div>`, postert: "WeddingPosters/10.jpg" },
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index=el.target.id;
        poster.src=`WeddingPosters/${index}.jpg`;
        DownloadMusic.href=`WeddingSongs/${index}.mp3`;
        music.src=`WeddingSongs/${index}.mp3`;
