...
var songarr = [
    { id: "1", songname: `Intaha Ho Gai Intezar Ki <br><div class = "subtitle" >Asha Bhosle </div>`, postert: "OldPosters/1.jpg" },
    { id: "2", songname: `Barsaat Ke Mausam Mein<br><div class = "subtitle" >Kumar Sanu</div>`, postert: "OldPosters/2.jpg" },
    { id: "3", songname: `Aaye Ho Meri Zindagi Mein<br><div class = "subtitle" >Udit Narayan</div>`, postert: "OldPosters/3.jpg" },
    { id: "4", songname: `Dil Hai Ki Manta Nahin<br><div class = "subtitle" > Anuradha Paudwal</div>`, postert: "OldPosters/4.jpg" },
    { id: "5",songname: `Mere Haathon Mein <br><div class = "subtitle" >Shiv-Hari</div>`, postert: "OldPosters/5.jpg" },
    { id: "6", songname: `Khaike Paan Banaraswala <br><div class = "subtitle" >Amitabh Bachchan</div>`, postert: "OldPosters/6.jpg" },
    { id: "7", songname: `Rang Barse<br><div class = "subtitle" >Amitabh Bachchan </div>`, postert: "OldPosters/7.jpg" },
    { id: "8", songname: `Mujhe Haq hai<br><div class = "subtitle" >Shreya Ghoshal</div>`, postert: "OldPosters/8.jpg" },
    { id: "9", songname: `Dil Mera Tod Dia Usne<br><div class = "subtitle" >Alka Yagnik</div>`, postert: "OldPosters/9.jpg" },
    { id: "10", songname: `Main Chahta Hoon <br><div class = "subtitle" >Abhijeet, Alka Yagnik</div>`, postert: "OldPosters/10.jpg" },
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index=el.target.id;
        poster.src=`OldPosters/${index}.jpg`;
        DownloadMusic.href=`OldSongs/${index}.mp3`;
        music.src=`OldSongs/${index}.mp3`;
