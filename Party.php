    ...
    <header>
        ...
        <div class="user">
            ...
            <div class="menu-song">
                <li class="songItem">   
                    <span>01</span>
                    <img src="PartyPosters/1.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>02</span>
                    <img src="PartyPosters/2.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>03</span>
                    <img src="PartyPosters/3.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>04</span>
                    <img src="PartyPosters/4.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>05</span>
                    <img src="PartyPosters/5.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                    <h5>
                    Taki Taki
                        <div class="subtitle">Dj Snake</div>
                ...
                <li class="songItem">
                    <span>06</span>
                    <img src="PartyPosters/6.jpg" alt="Piya aaye na">
        ...
        <div class="icon">
         ...
         <img src="PartyPosters/1.jpg" alt="KK & Tulsi kumar" id="small_poster">
         <h5 class="sname">Playing<br>
            ...
            <a href="PartySongs/1.mp3" id="DownloadMusic" download><i class="bi bi-cloud-arrow-down-fill" id="DownloadBtnn"></i></a>
        ...
        <script src="Partyscript.js"></script>
</body>
</html>