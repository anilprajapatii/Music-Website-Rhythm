...
var songarr = [
    { id: "1", songname: `Mareeze-E-Ishq<br><div class = "subtitle" >Arijit</div>`, postert: "RomanticPosters/1.jpg" },
    { id: "2", songname: `Pachtaoge<br><div class = "subtitle" >Arijit</div>`, postert: "RomanticPosters/2.jpg" },
    { id: "3", songname: `Valam<br><div class = "subtitle" >Arijit</div>`, postert: "RomanticPosters/3.jpg" },
    { id: "4", songname: `Itni Si Baat Hain<br><div class = "subtitle" >Arijit</div>`, postert: "RomanticPosters/4.jpg" },
    { id: "5",songname: `Main Dhoodne ko<br><div class = "subtitle" >Arijit</div>`, postert: "RomanticPosters/5.jpg" },
    { id: "6", songname: `Jashn-E-Bahara<br><div class = "subtitle" >Akriti</div>`, postert: "RomanticPosters/6.jpg" },
    { id: "7", songname: `Kabhi Aayine pe<br><div class = "subtitle" >J</div>`, postert: "RomanticPosters/7.jpg" },
    { id: "8", songname: `Kaise Hua<br><div class = "subtitle" >Vishal Mishra</div>`, postert: "RomanticPosters/8.jpg" },
    { id: "9", songname: `Tujhe kitna Chahne<br><div class = "subtitle" >Arijit</div>`, postert: "RomanticPosters/9.jpg" },
    { id: "10", songname: `Teri Meri Prem kahani<br><div class = "subtitle" >Rahat fateh ali</div>`, postert: "RomanticPosters/10.jpg" },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index=el.target.id;
        poster.src=`RomanticPosters/${index}.jpg`;
        DownloadMusic.href=`RomanticSongs/${index}.mp3`;
        music.src=`RomanticSongs/${index}.mp3`;
