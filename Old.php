    ...
    <header>
        ...
        <div class="user">
            ...
            <div class="menu-song">
                <li class="songItem">
                    <span>01</span>
                    <img src="OldPosters/1.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>02</span>
                    <img src="OldPosters/2.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>03</span>
                    <img src="OldPosters/3.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>04</span>
                    <img src="OldPosters/4.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>05</span>
                    <img src="OldPosters/5.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                    <h5>
                    Mere Haathon Mein
                        <div class="subtitle">Shiv-Hari</div>
                    </h5>
                </li>
                <li class="songItem">
                    <span>06</span>
                    <img src="OldPosters/6.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="6"></i>
                    <h5>
                    Khaike Paan Banaraswala
                        <div class="subtitle">Amitabh Bachchan</div>
                    </h5>
                </li>
            </div>
        </div>
        ...
        <div class="icon">
         ...
         <img src="OldPosters/1.jpg" alt="KK & Tulsi kumar" id="small_poster">
         <h5 class="sname">Playing<br>
            ...
            <a href="OldSongs/1.mp3" id="DownloadMusic" download><i class="bi bi-cloud-arrow-down-fill" id="DownloadBtnn"></i></a>
