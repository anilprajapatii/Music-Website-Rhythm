...
// Change song name in song array
// change path of poster and song

 // Step 1: Create the songarr array
var songarr = [
    { id: "1", songname: `Cheap Thrills<br><div class = "subtitle" >Sia</div>`, postert: "PartyPosters/1.jpg" },
    { id: "2", songname: `Chammak Challo<br><div class = "subtitle" >Akon</div>`, postert: "PartyPosters/2.jpg" },
    { id: "3", songname: `Magenta Riddim<br><div class = "subtitle" >Dj Snake</div>`, postert: "PartyPosters/3.jpg" },
    { id: "4", songname: `Excuses<br><div class = "subtitle" >Ap Dhillon</div>`, postert: "PartyPosters/4.jpg" },
    { id: "5",songname: `Taki Taki<br><div class = "subtitle" >Dj Snake</div>`, postert: "PartyPosters/5.jpg" },
    { id: "6", songname: `Genda phool<br><div class = "subtitle" >Badshah</div>`, postert: "PartyPosters/6.jpg" },
    { id: "7", songname: `Light It Up<br><div class = "subtitle" >Major lazer</div>`, postert: "PartyPosters/7.jpg" },
    { id: "8", songname: `Starboy<br><div class = "subtitle" >Weekend</div>`, postert: "PartyPosters/8.jpg" },
    { id: "9", songname: `Balam Pichkari<br><div class = "subtitle" >Pritam</div>`, postert: "PartyPosters/9.jpg" },
    { id: "10", songname: `Dil Cheej Tujhe De Di<br><div class = "subtitle" >Ankit Tiwari</div>`, postert: "PartyPosters/10.jpg" },   
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index=el.target.id;
        poster.src=`PartyPosters/${index}.jpg`;
        DownloadMusic.href=`PartySongs/${index}.mp3`;
        music.src=`PartySongs/${index}.mp3`;
