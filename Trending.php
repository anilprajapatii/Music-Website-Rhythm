...
<body>
    <header>
        ...
        <div class="menu-side">
         <div class="user">
            ...
            <div class="menu-song">
                <li class="songItem">
                    <span>01</span>
                    <img src="TrendingPosters/1.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>02</span>
                    <img src="TrendingPosters/2.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>03</span>
                    <img src="TrendingPosters/3.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                    <h5>
                       Dard dilo ke
                        <div class="subtitle">Himesh</div>
                    </h5>  
                </li>
                <li class="songItem">
                    <span>04</span>
                    <img src="TrendingPosters/4.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="4"></i>
                    <h5>
                        Daru badnaam 
                        <div class="subtitle">Kamal</div>
                    </h5>    
                </li>
                <li class="songItem">
                    <span>05</span>
                    <img src="TrendingPosters/5.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                    <h5>
                        Beautiful
                ...
                <li class="songItem">
                    <span>06</span>
                    <img src="TrendingPosters/6.jpg" alt="Piya aaye na">
        ...
        <div class="masterplay">
         ...
         <img src="TrendingPosters/1.jpg" alt="KK & Tulsi kumar" id="small_poster">
         <h5 class="sname">Playing<br>
            ...
            <a href="TrendingSongs/1.mp3" id="DownloadMusic" download><i class="bi bi-cloud-arrow-down-fill" id="DownloadBtnn"></i></a>
        ...
        <script src="Trendingscript.js"></script>
</body>
</html>