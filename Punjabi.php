    ...
    <header>
        ...
        <div class="user">
            ...
            <div class="menu-song">
                <li class="songItem">
                    <span>01</span>
                    <img src="PunjabiPosters/1.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="1"></i>
                    <h5>
                        Da Da Dasse 
                        <div class="subtitle">Amit Triv</div>
                    </h5>
                </li>
                <li class="songItem">
                    <span>02</span>
                    <img src="PunjabiPosters/2.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>03</span>
                    <img src="PunjabiPosters/3.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>04</span>
                    <img src="PunjabiPosters/4.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>05</span>
                    <img src="PunjabiPosters/5.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                    <h5>
                        Prada  
                        <div class="subtitle">Jass Manak</div>
                ...
                <li class="songItem">
                    <span>06</span>
                    <img src="PunjabiPosters/6.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="6"></i>
                    <h5>
                       Pyaar 
                        <div class="subtitle">Mani</div>
                    </h5>
                </li>
            </div>
        </div>
        ...
        <div class="song-side">
            ...
            <div class="content">
                <br>
                <h1>Top #10 Punjabi Songs </h1>
                <p>
                    <br>
                   Checkout the leatest release
                    <br>                 
                </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="icon">
         ...
         <img src="PunjabiPosters/1.jpg" alt="KK & Tulsi kumar" id="small_poster">
         <h5 class="sname">Playing<br>
            ...
            <a href="PunjabiSongs/1.mp3" id="DownloadMusic" download><i class="bi bi-cloud-arrow-down-fill" id="DownloadBtnn"></i></a>
        ...
        <script src="Punjabiscript.js"></script>
</body>
</html>