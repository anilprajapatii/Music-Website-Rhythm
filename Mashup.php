    ...
    <header>
        ...
        <div class="menu-side">
            ...
            <div class="menu-song">
                <li class="songItem">
                    <span>01</span>
                    <img src="MashupPosters/1.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="1"></i>
                    <h5>
                    Baarish
                        <div class="subtitle">Mashup</div>
                    </h5>
                </li>
                <li class="songItem">
                    <span>02</span>
                    <img src="MashupPosters/2.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>03</span>
                    <img src="MashupPosters/3.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>04</span>
                    <img src="MashupPosters/4.jpg" alt="Piya aaye na">
                ...
                <li class="songItem">
                    <span>05</span>
                    <img src="MashupPosters/5.jpg" alt="Piya aaye na">
                    <i class="bi playListPlay bi-play-circle-fill" id="3"></i>
                    <h5>
                    Kali Kali Zulfon
                        <div class="subtitle">Mashup</div>
                ...
                <li class="songItem">
                    <span>06</span>
                    <img src="MashupPosters/6.jpg" alt="Piya aaye na">
        ...
        <div class="song-side">
            ...
            <div class="content">
                <br>
                <h1>Top #10 Mashup Songs </h1>
                <p>
                    <br>
                   Remix Songs 
                    <br>Lofi(Sowed-version)                    
                </p>
                <div class="buttons">
                <button>Play</button>
                </div>
        ...
        <div class="icon">
         ...
         <img src="MashupPosters/1.jpg" alt="KK & Tulsi kumar" id="small_poster">
         <h5 class="sname">Playing<br>
            ...
            <a href="MashupSongs/1.mp3" id="DownloadMashup" download><i class="bi bi-cloud-arrow-down-fill" id="DownloadBtnn"></i></a>
        ...
        <script src="Mashupscript.js"></script>
</body>
</html>